	...
	namespace SGD_IMPLEMENTATION
	{
		...
		bool GraphicsManager::DrawRectangle( Rectangle rect, Color fillColor, Color lineColor, unsigned int lineWidth )
		{
			...
			if( lineColor.alpha > 0 && lineWidth > 0 )
			{
				...
				float halfLineWidth = (float)lineWidth * 0.5f;
				...
				transform.m[ 0 ][ 0 ] = (FLOAT)width - 0.5f;
				transform.m[ 1 ][ 1 ] = (FLOAT)lineWidth;

				transform.m[ 3 ][ 0 ] = (FLOAT)(rect.left - halfLineWidth + 0.5f);
				transform.m[ 3 ][ 1 ] = (FLOAT)(rect.top  - halfLineWidth + 0.5f);
				...
				transform.m[ 3 ][ 0 ] = (FLOAT)(rect.left   + halfLineWidth + 0.5f);
				transform.m[ 3 ][ 1 ] = (FLOAT)(rect.bottom - halfLineWidth);
				...
				transform.m[ 0 ][ 0 ] = (FLOAT)lineWidth;
				transform.m[ 1 ][ 1 ] = (FLOAT)height - 0.5f;
				...
				transform.m[ 3 ][ 0 ] = (FLOAT)(rect.right - halfLineWidth);
				transform.m[ 3 ][ 1 ] = (FLOAT)(rect.top   - halfLineWidth + 0.5f);
				...
				if( fillColor.alpha > 0 )
				{
					...
					transform.m[0][0] = (FLOAT)(rect.right  - rect.left - (lineWidth + 1));
					transform.m[1][1] = (FLOAT)(rect.bottom - rect.top  - (lineWidth + 1));

					transform.m[3][0] = (FLOAT)(rect.left + (lineWidth * 0.5f + 0.5f));
					transform.m[3][1] = (FLOAT)(rect.top  + (lineWidth * 0.5f + 0.5f));
			...
			else if( fillColor.alpha > 0 ) // Just the rect?
			{
				...
				transform.m[0][0] = (FLOAT)(rect.right  - rect.left);
				transform.m[1][1] = (FLOAT)(rect.bottom - rect.top);

				transform.m[3][0] = (FLOAT)(rect.left);
				transform.m[3][1] = (FLOAT)(rect.top);
