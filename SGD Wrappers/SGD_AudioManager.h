...
namespace SGD
{
	...
	public:
		...
		enum VolumeType { MASTER_MUSIC, MASTER_SOUND_EFFECTS };
		virtual int			GetMasterVolume( VolumeType type )								= 0;
		virtual bool		SetMasterVolume( VolumeType type, int value = 100 )				= 0;

		//virtual int 		GetMusicMasterVolume		( void )							= 0;
		//virtual bool		SetMusicMasterVolume		( int value = 100 )					= 0;
		//virtual int 		GetSoundEffectsMasterVolume	( void )							= 0;
		//virtual bool		SetSoundEffectsMasterVolume	( int value = 100 )					= 0;
