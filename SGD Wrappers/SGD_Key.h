...
namespace SGD
{
	...
	{ 
		...
		Backspace			= 8,	Back				= 8,		// Backspace
		Tab					= 9,
		Clear				= 12,
		Enter				= 13,	Return				= 13,		// Enter / Return
		Shift				= 16,									// Either Shift Key
		Control				= 17,									// Either Ctrl Key
		Alt					= 18,	Menu				= 18,		// Either Alt / Menu Key
		Pause				= 19,
		CapsLock			= 20,	Capital				= 20,		// CapsLock / Capital
		Escape				= 27,
		Spacebar			= 32,	Space				= 32,		// Spacebar / Space
		PageUp				= 33,	Prior				= 33,		// PageUp / Prior
		PageDown			= 34,	Next				= 34,		// PageDown / Next
		End					= 35,
		Home				= 36,
		LeftArrow			= 37,	Left				= 37,		// Left Arrow / Left
		UpArrow				= 38,	Up					= 38,		// Up Arrow / Up
		RightArrow			= 39,	Right				= 39,		// Right Arrow / Right
		DownArrow			= 40,	Down				= 40,		// Down Arrow / Down
		Select				= 41,
		Print				= 42,
		Execute				= 43,
		PrintScreen			= 44,	Snapshot			= 44,		// PrintScreen / Snapshot
		Insert				= 45,
		Delete				= 46,
		Help				= 47,
		...
		F24					= 135,
		NumLock				= 144,
		ScrollLock			= 145,	Scroll				= 145,		// Scroll Lock
		LeftShift			= 160,
		RightShift			= 161,
		LeftControl			= 162,
		RightControl		= 163,
		LeftAlt				= 164,	LeftMenu			= 164,		// LeftAlt / LeftMenu
		RightAlt			= 165,	RightMenu			= 165,		// RightAlt / RightMenu
		BrowserBack			= 166,
		BrowserForward		= 167,
		BrowserRefresh		= 168,
		BrowserStop			= 169,
		...
		MediaPlayPause		= 179,
		LaunchMail			= 180,
		SelectMedia			= 181,	LaunchMediaSelect	= 181,		// SelectMedia / LaunchMediaSelect
